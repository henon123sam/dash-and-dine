      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
        ...
        <div className="flex gap-4 mt-4">
          <button
            ...
            className="flex-1 py-2.5 border border-gray-300 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-2 text-sm"
          >
            Google
          </button>
          <button
            type="button"
            onClick={() => onLoggedIn('github_user@github.com')}
            className="flex-1 py-2.5 border border-gray-300 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition flex items-center justify-center gap-2 text-sm"
          >
            GitHub
          </button>
